...
[,]  Toggle between boolean sub-tree operations
  ...
  read_triangle_mesh(DATA_PATH "/cube.obj"     ,VA,FA);
  read_triangle_mesh(DATA_PATH "/sphere.obj"   ,VB,FB);
  read_triangle_mesh(DATA_PATH "/xcylinder.obj",VC,FC);
  read_triangle_mesh(DATA_PATH "/ycylinder.obj",VD,FD);
  read_triangle_mesh(DATA_PATH "/zcylinder.obj",VE,FE);
